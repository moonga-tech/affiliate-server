...
//Dress Size
const dress_size = document.getElementById("dress_size");

//Facebook
const facebook_input = document.getElementById("facebook_input");

//TikTok
const tiktok_input = document.getElementById("tiktok_input");

//Instagram
const instagram_input = document.getElementById("instagram_input");
...
submit_Button.addEventListener("click", function() {
  show_loading();
  const url = `https://lydiahouse.onrender.com/api/v1/register/model`
  //const url = `http://localhost:600/api/v1/register/model`;
  ...
  fetch(encoded, {
    ...
    body: JSON.stringify({
      ...
      shoeSize: shoe_size.value,
      dressSize: dress_size.value,
      facebook: facebook_input.value,
      tiktok: tiktok_input.value,
      instagram: instagram_input.value
    }),
    headers: {
    ...
    .then(async Response => {
      ...
      if (Response.status == 201) {
        alert("Successfully registered as a model");
        hide_loading();
        full_names.value = "";
        age.value = "";
        phoneNumber.value = "";
    ...
    .catch(error => {
      ...
      alert("Error processing details. Kindly contact support team on 0976240701 for help");
      hide_loading();
